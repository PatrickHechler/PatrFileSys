...
public class PatrFileSysNoSuchElementException extends NoSuchElementException implements PFSErr {
	...
	public PatrFileSysNoSuchElementException(int pfs_errno) {
		this(pfs_errno, null);
	}
	
	public PatrFileSysNoSuchElementException(int pfs_errno, String msg) {
