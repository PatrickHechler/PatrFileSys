...
extern i64 pfsc_element_get_name_length(pfs_eh e) {
	if (e->real_parent_place.block == -1) {
...
extern i64 pfsc_element_get_last_mod_time(pfs_eh e) {
	get_element(0)
...
extern int pfsc_element_set_last_mod_time(pfs_eh e, i64 new_time) {
	get_element(0)
