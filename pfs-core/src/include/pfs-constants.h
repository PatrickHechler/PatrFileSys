 ...
 */
#define	PFS_FLAGS_HELPER_FOLDER   0x00000080U /* folders with this flag should not be passed to the outside */

#define	PFS_FLAGS_EXECUTABLE 0x00000100U
#define	PFS_FLAGS_ENCRYPTED  0x00000200U
