 ...
 */
ui32 pfs_element_get_flags(pfs_eh e);
 ...
 */
int pfs_element_modify_flags(pfs_eh e, ui32 add_flags, ui32 rem_flags);
 ...
 */
i64 pfs_element_get_name_length(pfs_eh e);
 ...
 */
int pfs_element_get_name(pfs_eh e, char **buffer, i64 *buffer_len);
 ...
 * if the operation fails 0 is returned and on success 1
 */
int pfs_element_set_name(pfs_eh e, char *name);
 ...
 */
i64 pfs_element_get_create_time(pfs_eh e);

/**
 * set the create time of the given pfs-element
 */
int pfs_element_set_create_time(pfs_eh e, i64 new_time);
 ...
 */
i64 pfs_element_get_last_mod_time(pfs_eh e);

/**
 * set the last modify time of the given pfs-element
 */
int pfs_element_set_last_mod_time(pfs_eh e, i64 new_time);
 ...
 */
int pfs_element_delete(pfs_eh e);
 ...
 */
int pfs_element_get_parent(pfs_eh e);
 ...
 */
int pfs_element_set_parent(pfs_eh e, pfs_eh new_parent);
 ...
 * (to PFS_ERRNO_NONE on success)
 */
int pfs_element_move(pfs_eh e, pfs_eh new_parent, char *name);
