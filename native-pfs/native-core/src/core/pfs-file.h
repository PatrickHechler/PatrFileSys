 ...
 */
int pfs_file_read(pfs_eh f, i64 position, void *buffer, i64 length);
 ...
 * if position + length is greater than the files length this operation will fail
 */
int pfs_file_write(pfs_eh f, i64 position, void *data, i64 length);
 ...
 */
i64 pfs_file_append(pfs_eh f, void *data, i64 length);
 ...
 */
int pfs_file_truncate(pfs_eh f, i64 new_length);
