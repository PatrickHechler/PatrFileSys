 ...
 */
pfs_fi pfs_folder_iterator(pfs_eh f, int show_hidden);
 ...
 */
int pfs_folder_fill_iterator(pfs_eh f, pfs_fi iter, int show_hidden);
 ...
 */
int pfs_folder_iter_next(pfs_fi fi);
 ...
 */
i64 pfs_folder_child_count(pfs_eh f);
 ...
 */
int pfs_folder_child_from_name(pfs_eh f, char *name);
 ...
 * on success a non-zero value will be returned and on error zero
 */
int pfs_folder_folder_child_from_name(pfs_eh f, char *name);
 ...
 * on success a non-zero value will be returned and on error zero
 */
int pfs_folder_file_child_from_name(pfs_eh f, char *name);
 ...
 * on success a non-zero value will be returned and on error zero
 */
int pfs_folder_pipe_child_from_name(pfs_eh f, char *name);
 ...
 * on success a non-zero value will be returned and on error zero
 */
int pfs_folder_create_folder(pfs_eh f, pfs_eh parent, const char *name);
 ...
 * on success a non-zero value will be returned and on error zero
 */
int pfs_folder_create_file(pfs_eh f, pfs_eh parent, const char *name);
 ...
 * on success a non-zero value will be returned and on error zero
 */
int pfs_folder_create_pipe(pfs_eh f, pfs_eh parent, const char *name);
